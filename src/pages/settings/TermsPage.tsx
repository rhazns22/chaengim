            ...
            <div className="space-y-6 text-[14px] leading-relaxed text-textMain">
              ...
              <section>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>허위 이메일 인증 또는 정상적인 인증 절차를 고의로 우회, 방해 및 악용하는 행위</li>
              ...
              <section>
                <h3 className="mb-2 text-[15px] font-bold text-textMain">8. 알림 서비스</h3>
                <p className="mb-2">서비스는 사용자가 저장한 혜택의 마감일, 신청 준비 상태(체크리스트 미완료 현황), 중요 서비스 공지 등을 시기적절하게 안내하기 위해 스마트폰 로컬 또는 푸시 알림 기능을 제공할 수 있습니다.</p>
                <p className="mb-2 font-semibold text-primary">※ 알림은 오직 이용자의 일정 누락 방지를 돕기 위한 1차 편의적 참고용 리마인더이며, 실제 혜택 수급, 지원금 지급, 선정 성공을 어떠한 경우에도 보장하지 않습니다.</p>
                <p className="mb-2">이용자는 앱 내부의 알림 설정 페이지 혹은 개별 모바일 디바이스의 시스템 설정 메뉴를 통하여 알림 동의를 언제든지 자율적으로 비활성화하거나 수신 거부하실 수 있습니다.</p>
                <p>광고, 홍보, 마케팅 및 신규 이벤트성 알림은 기본적으로 수신 동의가 비활성화(OFF)되어 있으며, 이용자가 약관 및 수신 동의를 명시적으로 수락한 때에 한하여서만 발송됩니다.</p>
              </section>

              <section>
                <h3 className="mb-2 text-[15px] font-bold text-textMain">9. 서비스 변경 및 중단</h3>
              ...
              <section>
                <h3 className="mb-2 text-[15px] font-bold text-textMain">10. 서비스 운영 주체 변경 및 양도</h3>
                <p className="mb-2">서비스는 운영자의 사정, 서비스 확장, 제휴, 양도, 인수, 합병, 분할, 자산 이전 등으로 인해 운영 주체가 변경될 수 있습니다.</p>
                <p className="mb-2">이 경우 운영자는 관련 법령에서 정한 절차에 따라 이용자에게 변경 사실, 변경되는 운영 주체, 서비스 이용 조건의 주요 변경 사항을 사전에 안내하거나 공지합니다.</p>
                <p className="mb-2">운영자는 운영 주체 변경, 서비스 양도, 인수, 합병 등이 발생하는 경우 서비스 내 공지사항, 이메일, 앱 알림, 웹사이트 공지 등 이용자가 확인할 수 있는 방법으로 관련 내용을 안내할 수 있습니다.</p>
                <p className="mb-2">운영 주체가 변경되더라도 기존 이용약관과 개인정보처리방침에 따른 이용자의 권리는 관련 법령이 허용하는 범위 내에서 보호됩니다.</p>
                <p className="mb-2">이용자는 운영 주체 변경 또는 서비스 양도에 동의하지 않는 경우 회원 탈퇴 또는 계정 및 데이터 삭제를 요청할 수 있습니다.</p>
                <p>※ 서비스의 양도, 인수, 합병 등이 발생하더라도 챙김은 정부기관을 대리하지 않으며, 정부 혜택의 신청 가능 여부, 지급 여부, 선정 여부를 보장하지 않습니다.</p>
              </section>

              <section>
                <h3 className="mb-2 text-[15px] font-bold text-textMain">11. 외부 연결 링크</h3>
              ...
              <section>
                <h3 className="mb-2 text-[15px] font-bold text-textMain">12. 책임의 제한</h3>
              ...
              <section>
                <h3 className="mb-2 text-[15px] font-bold text-textMain">13. 계정 삭제 및 탈퇴</h3>
              ...
              <section>
                <h3 className="mb-2 text-[15px] font-bold text-textMain">14. 약관의 효력 및 개정</h3>
